...
public final class Client {
    static {
        try {
            ...
            throw new RuntimeException("无法找到 tdjni");
        }
    }
    ...
    public interface ResultHandler {
         ...
         *
         * @param object Result of query or update of type MyApi.Update about new events.
         */
     ...
     *                         of the query or with MyApi.Error as parameter. If it is null, nothing
     *                         will be called.
     ...
     * @param query         Object representing a query to the TDLib.
     * @param resultHandler Result handler with onResult method which will be called with result
     *                      of the query or with MyApi.Error as parameter. If it is null, then
     *                      defaultExceptionHandler will be called.
     */
